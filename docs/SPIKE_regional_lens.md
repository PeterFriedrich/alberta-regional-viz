...
> **Provenance:** copied verbatim from `edmonton-tax-viz/docs/SPIKE_regional_lens.md` (PR #69 there) on 2026-09-18 when this project was split out. Facts and prices are as of the spike date; re-fetch before building on any of them.
